...
export function HealthLogs() {
  ...
  const tabs: HoverGradientTabItem[] = [
    ...
    { icon: <Coffee className="h-4 w-4" />, label: "Lifestyle", gradient: "radial-gradient(circle, rgba(34,197,94,0.15) 0%, rgba(22,163,74,0.06) 50%, rgba(21,128,61,0) 100%)", iconColor: "group-hover:text-green-500 dark:group-hover:text-green-400" },
  ];
