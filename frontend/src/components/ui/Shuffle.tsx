...
export const Shuffle: React.FC<ShuffleProps> = ({
  ...
  useGSAP(
    () => {
      ...
      const build = () => {
        ...
        // Manual text split implementation to replace GSAP SplitText
        el.textContent = '';
        ...
        words.forEach((word, wordIndex) => {
          ...
          if (wordIndex < words.length - 1) {
            ...
            spaceSpan.className = 'shuffle-char inline-block whitespace-pre';
  ...
  const Tag = (tag || 'h1') as keyof JSX.IntrinsicElements;
